...
def mds_torch(seismic_scenario, scaling_factors, constants, parameters, long_int, seis_int):
    ...
    #age=torch.zeros((len(durations)-1))
    ...
    """ Delete some variables to free memory """ # N_eq = len(age)  # number of earthquakes
